...
from schemas.usuario_schema import UsuarioSchemaBase, UsuarioSchemaUp, UsuarioSchemaArtigos, UsuarioSchemaCreate
...
async def get_usuario(usuario_id: int, db: AsyncSession = Depends(get_session)):
    async with db as session:
        ...
        if usuario:
            ...
            raise HTTPException(
                detail='Nemhum usuario com esse ID foi encontrado', status_code=status.HTTP_404_NOT_FOUND)
